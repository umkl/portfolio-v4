...
const Badge = ({ img, name }: { img: string; name: string }) => {
	return (
		<div className="relative m-8">
			...
			<p className="absolute uppercase whitespace-nowrap text-center w-fit top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-neutral-200 text-2xl ">
				{name}
			</p>
		</div>
	);
